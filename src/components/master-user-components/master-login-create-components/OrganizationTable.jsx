    ...
    <section className="bg-white rounded-xl shadow-sm border border-slate-100 overflow-hidden">
      <div className="p-4 border-b border-slate-200">
        <div className="flex flex-col sm:flex-row justify-between sm:items-center gap-4">
          <h2 className="text-xl font-bold text-slate-900">Organizations & Login Management</h2>
              ...
              <tr key={organization._id} className="hover:bg-slate-50">
                <td className="p-4">
                  <div>
                    ...
                    <div className="text-xs text-slate-500">{organization.adminEmail}</div>
                  </div>
                </td>
                <td className="p-4">
                  <div className="text-sm text-slate-600">
                    <div>{organization.district}, {organization.state}</div>
                    <div className="text-xs text-slate-500">{organization.country}</div>
                  </div>
                </td>
                <td className="p-4">
